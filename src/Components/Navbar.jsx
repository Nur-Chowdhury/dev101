  ...
  return (
    <>
      <header
          ...
          className="relative z-[999] border-b-[1px]  border-primary/50 bg-gradient-to-l from-violet-900 via-violet-800 to-violet-900 text-white shadow-lg"
        >
          <nav className="container  flex h-[70px] items-center justify-between py-2 ">
            <div className="text-2xl text-white md:text-3xl ">
              <a href="/#home" className="">
                DEV
                <span className="inline-block font-bold text-primary">101</span>
              </a>
            </div>
